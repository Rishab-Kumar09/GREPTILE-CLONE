          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-blue-800">Connect GitHub for Real Repository Data</h3>
                  <p className="text-sm text-blue-700">You're currently viewing demo data. Connect your GitHub account to analyze your real repositories.</p>
                </div>
              </div>
              <a
                href="/setup"
